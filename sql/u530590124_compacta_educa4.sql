...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2025 a las 18:53:11
...
CREATE TABLE `ti_fase0` (
  `id_alu` varchar(50) NOT NULL,
  `f_completado` tinyint(1) NOT NULL DEFAULT 0,
  `mp_completado` tinyint(1) NOT NULL DEFAULT 0,
  `oi_completado` tinyint(1) NOT NULL DEFAULT 0,
  `r1_completado` tinyint(1) NOT NULL DEFAULT 0,
  `r2_completado` tinyint(1) NOT NULL DEFAULT 0,
  `r3_completado` tinyint(1) NOT NULL DEFAULT 0,
  `r4_completado` tinyint(1) NOT NULL DEFAULT 0,
  `fase0_completada` tinyint(1) GENERATED ALWAYS AS (`f_completado` <> 0 and `mp_completado` <> 0 and `oi_completado` <> 0 and `r1_completado` <> 0 and `r2_completado` <> 0 and `r3_completado` <> 0 and `r4_completado` <> 0) STORED
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Filtros para la tabla `ti_fase0`
--
ALTER TABLE `ti_fase0`
  ADD CONSTRAINT `fk_fase0_alumno` FOREIGN KEY (`id_alu`) REFERENCES `ti_alu1` (`id_alu`) ON DELETE CASCADE ON UPDATE CASCADE;
